...
author_auc = [81.42, 76.57, 96.98, 98.47]
self_auc = [81.41, 76.52, 97.1, 98.45]
author_logloss = [43.77, 36.66, 21.07, 14.71]
self_logloss = [43.79, 36.77, 20.91, 15.22]
...
ax1.set_ylabel('AUC')
ax1.set_title('AUC Comparison for DualMLP on Different Datasets')  # 修改标题
...
ax2.set_title('Logloss Comparison for DualMLP on Different Datasets')  # 修改标题
...
# 调整布局以避免重叠
plt.tight_layout()
plt.savefig('D:\\PapersCode\\FinalMLP\\result_csv\\DualMPL.png', dpi=300)
# 显示图形
plt.show()
